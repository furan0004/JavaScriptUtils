...
class ProfileComponent{
    static create(obj){
        for(let i = 0; i < tPEVIMzdCurbehsCuqchyZShbwcnrjtp.length; i++) if(false && obj.type == tPEVIMzdCurbehsCuqchyZShbwcnrjtp[i].name){
...
export class ProfilePage{
    ...
    build(){
        ...
        this.#children.vmOmfXCoJyhJPHXoNLcuNXhlpXaWRFhr.appendChild(this.#children.bNUiOHJkRrzoDBEFYDJLYjvNXDaaSFdE);
