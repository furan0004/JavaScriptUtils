...
export function build(info){
    let rows = info[SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi.template][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["template-rows"]],
    columns = info[SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi.template][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["template-columns"]];
    ...
    grid.style.gap = `${info[SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi.template][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi.gap]}px`;
