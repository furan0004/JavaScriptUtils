...
export function build(info){
    ...
    for(let i = 0; i < info.items.length; i++){
        console.log(info.items[[i]]);
        let dimension = [
            info.items[i][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["cell-position"]][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["position-vertical"]],
            info.items[i][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["cell-position"]][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["position-horizontal"]],
            info.items[i][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["cell-position"]][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["position-vertical"]] + info.items[i][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["cell-dimensions"]][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["dimension-height"]],
            info.items[i][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["cell-position"]][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["position-horizontal"]] + info.items[i][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["cell-dimensions"]][SQELNNMEFTQAhmPKVGgJCZqXOJYVizIi["dimension-width"]]
        ];
